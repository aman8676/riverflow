...
const Answers = ({
   answers: _answers,
    ...
    questionId: string;
     ...
     return (
       <>
         <h2 className="text-lg font-bold">{answers.total} Answers</h2>
         {answers.documents.map((answer:any) => (
           <div
             key={answer.$id}
             className="relative rounded-lg bg-muted p-4 flex gap-4"
           >
             <div className="flex shrink-0 flex-col items-center gap-2">
               ...
               {user?.$id === answer.authorId ? (
                 ...
                 >
                   <IconTrash size={16} className="h-4 w-4" />
                 </button>
               ) : null}
             </div>
             <div className="w-full overflow -auto">
               ...
               <div className="mt-4 flex items-center justify-end gap-1">
                 <picture>
                   <img
                     src={avatar.getInitials(answer.author.name, 36, 36)}
